...
function showUI(dataArray) {
    ...
    dataArray.forEach(val => {
        ...
        const borderClass = val.status === 'open'
            ? 'issue-card-open'
            : 'issue-card-closed';
        ...
        ${
            ...
            `).join('')
                : `<span class="text-[9px] font-black px-2 py-0.5 rounded border uppercase bg-gray-100 text-gray-400 border-gray-200">
                No Label
                </span>`
        }
        </div>
